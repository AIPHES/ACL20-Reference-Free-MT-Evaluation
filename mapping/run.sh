...
rm -f $L2-$L1.tgz
python3 prep_parallel.py --bert_model $MODEL --lang1 $OUTPUT_PATH/europarl-v7.$L2-$L1.$L1 --lang2 $OUTPUT_PATH/europarl-v7.$L2-$L1.$L2 --size 30000 --output $OUTPUT_PATH/$PARA
